...
GET_LOCATION_DOCS = {
    ...
    "description": "Retorna os detalhes completos de um local específico incluindo itens de acessibilidade e imagens (consolidadas de comentários aprovados para renderização). Os comentários aprovados não são retornados na resposta.",
    "responses": {
        200: {
